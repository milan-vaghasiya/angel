$(document).ready(function(){
	...
	$(document).on("change","#location_id, #party_id, #emp_id",function(){
		var issue_to = $(this).find('option:selected').text();
...
function saveAssetsChallan(formId){
	var fd = $('#'+formId).serialize();
	$.ajax({
		url: base_url + controller + '/saveChallan',
		data:fd,
		type: "POST",
		dataType:"json",
	}).done(function(data){
