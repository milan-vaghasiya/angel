<form>
    <div class="col-md-12">
        ...
        <div class="col-md-3 form-group">
            <label for="installation_year">Installed On</label>
        ...
        <div class="col-md-2 form-group">
            <label for="prev_maint_req">Pre. Maintenance?</label>
            <select name="prev_maint_req" id="prev_maint_req" class="form-control select2">
        ...
        <div class="col-md-2 form-group">
            <label for="plan_days">Plan Days </label>
            <input type="text" name="plan_days" id="plan_days" class="form-control numericOnly" value="<?=(!empty($dataRow->plan_days))?$dataRow->plan_days:"0"?>">
        </div>
