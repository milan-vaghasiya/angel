<form>
    <div class="col-md-12">
        <div class="row">            
            ...
            <input type="hidden" name="status" id="status" value="<?=(!empty($dataRow['status']) ? $dataRow['status'] : "")?>" />

            <div class="col-md-12 form-group">
                <label for="conclusion">Conclusion</label>
                <textarea type="text" name="conclusion" id="conclusion" class="form-control"><?=(!empty($dataRow->conclusion) ? $dataRow->conclusion : "")?></textarea>
            </div>
