	...
	<div class="col-12">
		...
		<table class="table item-list-bb fs-22 text-left" style="margin-top:5px;">
            <tr>
                ...
                <td><?=date('Y-m-d H:i:s', strtotime($dataRow->me_date))?></td>
                <th style="width:15%;">Location</th>
                <td><?=$dataRow->location?></td>
            </tr>
            <tr>
                <th>Host By</th>
                <td><?=$dataRow->host_by?></td>
                <th>Guest</th>
                <td><?=$dataRow->guest?></td>
            </tr>
            <tr>
                <th>Key Contact</th>
                <td><?=$dataRow->key_contact?></td>
                <th>Attendee</th>
        ...
        <table style="margin-top:5px;">
           <tr>
                <td class="text-left" style="vertical-align:top;">
                    <b>Agenda :-</b><br> <?= nl2br(htmlspecialchars($dataRow->description)) ?>
                </td>
            </tr>
        </table>

        <table style="margin-top:10%;">
            <tr><td><b>Conclusion :- </b><br><?=nl2br(htmlspecialchars($dataRow->conclusion))?></td></tr>;
        </table>
