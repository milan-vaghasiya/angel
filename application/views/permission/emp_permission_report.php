                    ...
                    <div class="page-title-box">
                        <div class="float-start">
                            <ul class="nav nav-pills">
                                ...
                                <button type="button" class="btn waves-effect waves-light btn-outline-success float-center permission-write" onclick="modalAction({'modal_id' : 'modal-md', 'form_id' : 'copyPermission', 'fnedit':'copyPermission', 'call_function':'copyPermission', 'title' : 'Copy Permission', 'js_store_fn':'confirmStore', 'fnsave':'saveCopyPermission'});">Copy Permission</button>
                                            ...
                                            <div class="panel">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        <a data-toggle="collapse" data-parent="#bs-collapse" href="#menu_<?=$row->id?>"><?=$row->menu_name?></a>
                                                ...
                                                <div id="menu_<?=$row->id?>" class="panel-collapse collapse">
